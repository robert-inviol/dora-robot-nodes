"""Turning where the target is in the frame into a drive demand."""

from dataclasses import dataclass

from dora_rig_messages.drive import DriveDemand, PowerCap
...
class PursuitGains:
    turn: float
    forward: float
    # Share of the frame height the target's box fills at the distance the robot holds.
...
def pursue(target: Person, gains: PursuitGains) -> DriveDemand:
    ...
    return DriveDemand.limited(forward, turn, gains.max_power)
